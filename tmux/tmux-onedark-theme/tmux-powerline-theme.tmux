#!/bin/bash
onedark_black=color17
onedark_blue=color45
onedark_green=color40
onedark_red=color52
onedark_white=color251
onedark_yellow=color190
onedark_visual_grey=color238
onedark_comment_grey=color240
